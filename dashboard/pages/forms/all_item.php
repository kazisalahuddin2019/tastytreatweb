<?php
  ...
  $dblist_string2="SELECT * FROM `item`";
...
<!-- </a> -->
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>SL</th> <th>Code</th>  <th> Name </th> <th> Category </th><th> Action </th>
                </tr>
            </thead>
            <tbody>
                    <?php
                     $dblist=mysqli_num_rows($dbdata2);
                    if ($dblist>0) {
                      $i=0; 
                      while($row = $dbdata2->fetch_assoc()) {
                        ...
                        if ($status==0) {
                          ...
                          ?>
                              <tr>
                                  <td><?php echo $i;?></td><td><?php echo $row["itemcode"];?></td><td><?php echo $row["itemname"];?></td><td><?php echo $row["itemname"];?></td>
                                  <td>
