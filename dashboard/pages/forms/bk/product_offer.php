...
<?php
  ...
  $schlist_string="SELECT * FROM schedulee";
  $schdata = mysqli_query($con,$schlist_string);
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Kazi Md. Salahuddin - Web Developer
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <button type="button" class="btn btn-default btn-sm" id="btnadd"> Add  Schedule</button>
<!-- </a> -->
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>SL</th> <th>Schedule name</th>  <th> Start </th> <th> End </th>
                </tr>
            </thead>
            <tbody>
                    <?php
                     $dblist=mysqli_num_rows($schdata);
                    if ($dblist>0) {
                      $i=0; 
                      while($row = $schdata->fetch_assoc()) {
                        $i++;
                          ?>
                              <tr>
                                  <td><?php echo $i;?></td><td><?php echo $row["sch_name"];?></td><td><?php echo $row["starttime"];?></td><td><?php echo $row["endtime"];?></td>
                                  <td>
                        ...
                        <div class="form-group">
                          <label>Start</label>
                            <div class='input-group date' id='datetimepicker3'>
                                <input type='text' class="form-control" id="txtStartTime" data-default="20:48" name="schstart" />
                                <span class="input-group-addon" id="btnAddOnSetTime">
                            ...
                            <div class="form-group">
                              <label>Start</label>
                                <div class='input-group date' id='datetimepicker4'>
                                    <input type='text' class="form-control" id="txtStartTime" data-default="20:48" name="schend"/>
                                    <span class="input-group-addon" id="btnAddOnSetTime4" >
                                        <span class="glyphicon glyphicon-time" ></span>
                                    </span>
                                </div>
                            </div>
...
if(isset($_POST['submit'])){
    ...
    if ($schname=="") {
     ...
     echo '<script>window.alert("End time empty")</script>';
    }else{
       $dbchk_string="SELECT * FROM `schedulee` WHERE `sch_name` = '$schname' ";
       $insert_string="INSERT INTO schedulee (sch_name, starttime, endtime) VALUES ('$schname', '$schstart', '$schend')";
    ...
    //echo 'did'.mysqli_num_rows($sqldata);
       if (mysqli_num_rows($sqldata)==1){
        //echo 'exists'.mysqli_num_rows($sqldata);
          echo '<script>window.alert("Schedule name already exist")</script>';
       }else{
