<?php
  ...
  $dblist_string="SELECT * FROM `item`";
                        ...
                        if ($status==0) {
                          ...
                          ?>
                              <tr>
                                  ...
                                  <td>
                                    <a href="<?php echo 'showroom_list.php?id='.$row["id"];?>"><button type="button" class="btn btn-default btn-xs"><?php echo $val;?></button></a>
...
if(isset($_POST['submit'])){
    ...
    if ($code=="") {
     ...
     echo '<script>window.alert("Longitude  empty")</script>';
       ...
       $insert_string="INSERT INTO showroom (code,name, address, mobno,lat,lng) VALUES ('$code','$shname', '$address', '$mobno', '$lat', '$lng')";
