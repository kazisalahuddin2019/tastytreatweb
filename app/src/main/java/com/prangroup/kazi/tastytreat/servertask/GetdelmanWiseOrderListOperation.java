...
public class GetdelmanWiseOrderListOperation {
    private  static String UPLOAD_URL = ApiLinks.get_orderlistApi;
    static StringRequest stringRequest;

    static int MY_SOCKET_TIMEOUT_MS=1000000;
    public static  void sendDelID(final String userid,final String status, final Context context, final VolleyCallBack volleyCallBack){
...
//                        UPLOAD_URL="";
//                        UPLOAD_URL=ApiLinks.get_orderlistApi;
                        //loading.dismiss();
                        try {
