...
public class DeliveryManLoginOperation {
    private final static String UPLOAD_URL = ApiLinks.get_loginApi;
    static StringRequest stringRequest;

    static int MY_SOCKET_TIMEOUT_MS=1000000;
    public static  void sendLogionData(final String id,final String pw,final String token, final Activity activity, final Context context, final VolleyCallBack volleyCallBack){
