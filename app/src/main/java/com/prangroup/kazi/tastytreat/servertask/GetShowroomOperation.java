...
public class GetShowroomOperation {
    private final static String UPLOAD_URL = ApiLinks.get_showroomdataApi;
    static StringRequest stringRequest;

    static int MY_SOCKET_TIMEOUT_MS=1000000;
    public static  void getShowroomData(final Activity activity, final Context context, final VolleyCallBack volleyCallBack){
