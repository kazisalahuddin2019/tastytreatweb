...
public class DelCompleteFragment extends Fragment {
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_del_complete, container, false);
        ...
        GetdelmanWiseOrderListOperation.sendDelID(userid, "2", mContext, new VolleyCallBack() {
            @Override
