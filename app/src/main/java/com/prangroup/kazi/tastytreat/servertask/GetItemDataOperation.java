...
public class GetItemDataOperation {
    private  static String UPLOAD_URL = ApiLinks.get_itemdataApi;
    static StringRequest stringRequest;

    static int MY_SOCKET_TIMEOUT_MS=1000000;
    public static  void getItemData(String showroomList,final Activity activity, final Context context, final VolleyCallBack volleyCallBack){
        UPLOAD_URL=UPLOAD_URL+showroomList;
