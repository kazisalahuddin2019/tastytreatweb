...
public class OrderUpdateOperation {
    private final static String UPLOAD_URL = ApiLinks.get_productOrderUpdateApi;
    static StringRequest stringRequest;

    static int MY_SOCKET_TIMEOUT_MS=1000000;
    public static  void sendOrderData(final String id,final String status, final Activity activity, final Context context, final VolleyCallBack volleyCallBack){
